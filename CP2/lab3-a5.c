...
int main(void)
{
  ...
  while(t)
  {
    ...
    turn=player1;
    if((turn=player1) && (choice=='N')) //when it's player1's turn and they want to continue
    {
      player1 = 1+(rand()%6);
    ...
    else if ((turn=player1) && (choice=='Y')) //when it's player1's turn and they want to hold
    {
    ...
    turn=player2;
    if((turn=player2) && (choice=='N')) //when it's player2's turn and they want to continue
    {
      player2 = 1+(rand()%6);
      printf("Player2 rolled a %d.\n", player2);
    ...
    else if ((turn=player2) && (choice=='Y')) //when it's player2's turn and they want to hold
    {
