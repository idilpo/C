...
int score(int score1, int score2) //function that shows the scoreboard, gets updated each turn
{
...
int main(void)
{
  ...
  while(t) //main while loop that keeps running until someone reaches 100
  {
    ...
    do
    {
      ...
      printf("Player1: Do you wish to hold your turn? If yes, enter 'Y'. If no, enter 'N'. ");
      choice = getchar();
    ...
    {
     //if input is invalid, the loop keeps going on until a valid input is entered
     printf("Player2: Do you wish to hold your turn? If yes, enter 'Y'. If no, enter 'N'. ");
     choice = getchar();
     ...
     else if(choice == 'Y') //when it's player2's turn and they want to hold
     {
