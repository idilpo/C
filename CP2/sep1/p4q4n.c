...
int main()
{
    ...
    printf("The list of sorted results is as follows:\n");
...
/*
This function sorts NUM_RESULTS results in the array inputResults
...
/*  Start at i = 1, the first one is sorted.  */    {
        j = i;
        strcpy(val, inputResults[j]);
        while (j > 0  &&  strcmp(val, inputResults[j - 1]) < 0)
        {
